  ...
  return (
    <nav className="w-full bg-white flex justify-between items-center py-5 fixed top-0 left-0 z-20 shadow-sm">
      ...
      {menu ? (
        ...
        <div className="lg:hidden  absolute transition  text-center left-1/3 sm:left-1/6  flex items-center px-10">
          <button
      ...
      <div className="flex justify-around items-center mx-6 gap-8">
        ...
        <div className="flex gap-4  items-center justify-center">
          {open ? (
            <div className="fixed top-0 left-0  w-full bg-white-40 backdrop-blur-lg  py-4 flex justify-center items-center gap-5 z-100 border border-b-teal-500 md:px-0 px-5">
              <div className="md:w-[50%] flex place-items-center w-[100%]">
                <button
        ...
        {isLoggedin ? (
          <button
            className="bg-teal-700 py-3 px-4 rounded-sm font-semibold text-white text-sm cursor-pointer hidden lg:block"
            onClick={hadleLogout}
          >
            LogOut
          </button>
